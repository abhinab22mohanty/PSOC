// ======================================================================
// RobotDesign2.v generated from TopDesign.cysch
// 11/26/2018 at 18:47
...
module top ;
	...
	cy_clock_v1_0
		#(.id("53c324f0-4402-4ff5-a176-fb9d7536addf"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	wire [0:0] tmpOE__Right_Eyeball_Pan_net;
	wire [0:0] tmpFB_0__Right_Eyeball_Pan_net;
	wire [0:0] tmpIO_0__Right_Eyeball_Pan_net;
	wire [0:0] tmpINTERRUPT_0__Right_Eyeball_Pan_net;
	electrical [0:0] tmpSIOVREF__Right_Eyeball_Pan_net;
	...
	cy_psoc3_pins_v1_10
		...
		Right_Eyeball_Pan
		 (.oe(tmpOE__Right_Eyeball_Pan_net),
		  .y({Net_86}),
		  .fb({tmpFB_0__Right_Eyeball_Pan_net[0:0]}),
		  .io({tmpIO_0__Right_Eyeball_Pan_net[0:0]}),
		  .siovref(tmpSIOVREF__Right_Eyeball_Pan_net),
		  .interrupt({tmpINTERRUPT_0__Right_Eyeball_Pan_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Right_Eyeball_Pan_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Right_Eyeball_Tilt_net;
	wire [0:0] tmpFB_0__Right_Eyeball_Tilt_net;
	wire [0:0] tmpIO_0__Right_Eyeball_Tilt_net;
	wire [0:0] tmpINTERRUPT_0__Right_Eyeball_Tilt_net;
	electrical [0:0] tmpSIOVREF__Right_Eyeball_Tilt_net;

	cy_psoc3_pins_v1_10
		#(.id("b3e246e8-124f-4aaa-856a-e71e6f24bba3"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Right_Eyeball_Tilt
		 (.oe(tmpOE__Right_Eyeball_Tilt_net),
		  .y({Net_121}),
		  .fb({tmpFB_0__Right_Eyeball_Tilt_net[0:0]}),
		  .io({tmpIO_0__Right_Eyeball_Tilt_net[0:0]}),
		  .siovref(tmpSIOVREF__Right_Eyeball_Tilt_net),
		  .interrupt({tmpINTERRUPT_0__Right_Eyeball_Tilt_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Right_Eyeball_Tilt_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("ccace330-94db-46d4-a570-9d22d3dc3ad2"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
